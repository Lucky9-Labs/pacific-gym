...
| --- | --- | --- |
| 1 | Plugin shell and source intake | Install and invoke the skill and trusted hook; inspect both source GLBs without modification and verify their hashes and different rig structures. |
...
| 5 | Blender derivative | Import, repair, and export in local headless Blender; preserve the source and inspect the derivative from multiple views. |
